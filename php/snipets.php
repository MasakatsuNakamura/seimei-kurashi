...
<div data-role="page" id="setsumei">
	...
	<div data-role='content'>
		...
		<p style="font-weight:bold;line-height:180%;">
			...
			だいぶつは「山本式姓名判断」のサイト構築・監修を行った経験から、そのノウハウを知り尽くしています。<br>
			最初、山本翁は無料の姓名判断サービスを立ち上げるといっていましたので、私はそれに乗りました。すべ手無料でサービスの立ち上げからプログラムの作成、手伝いました。<br>
			私の助力なくして「山本式姓名判断」サイトは存在しませんでした。<br>
			しかし、気付けば彼は高額な命名料を目当てにサービスを行っているに過ぎませんでした。<br>
			そして、そのことを苦々しく思い指摘すると山本翁は「お金を請求しなかったお前が悪い」と開きお直りました。<br>
			お金が欲しいのではないのです。無料で、皆に姓名判断のメリットを享受してもらいたいからこそ私は無償で手伝ったのです。<br>
			彼の考え方は間違っていると思います。<br>
