...
<div data-role="page" id="setsumei">
	...
	<div data-role='content'>
		...
		<p style="font-weight:bold;line-height:180%;">
			...
			だいぶつは「<a href="http://keishinsya.jp/okina/" target="_blank">山本式姓名判断</a>」のサイト構築・監修を行った経験から、そのノウハウを知り尽くしています。<br>
			...
			私の助力なくして「<a href="http://keishinsya.jp/okina/" target="_blank">山本式姓名判断</a>」サイトは存在しなかったでしょう。<br>
			...
			あじあ姓名うらないという名前でサービスを運用していたのですが、彼はDMCAの制度を悪用し、検索インデックスから削除させました。<br>
