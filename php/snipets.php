...
<div data-role="page" id="setsumei">
	...
	<div data-role='content'>
		...
		<p style="font-weight:bold;line-height:180%;">
			...
			無償で姓名判断を皆に教授してもらうため、<a href="www.seimei.asia">あじあ姓名うらない</a>という名前でサービスを運用していたのですが(運用日は完全に個人持ちで、完全無料)、彼は<a href="https://www.chillingeffects.org/notices/2046981#">DMCAの制度を悪用し</a>、検索インデックスから削除させました。<br>
